...
export const productList: Product[] = [
  ...
  {
    id: 'f27f288c-c6cb-43b0-9f2a-d575ad37fe85',
    description: 'Delectus, ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat.',
    name: 'Fuzzy Jacket',
    price: 35,
    currency: 'USD',
